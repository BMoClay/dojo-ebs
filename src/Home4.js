...
// import logo1 from "./assets/logos/Fiery_Color_008 copy 2.png";
...
//   }, [yearFilter])
  ...
  //   const handleFilterYear = (id) => {
  //     let thisBook = books[id].year

  //     const booksByYear = books.filter((book) => console.log(book.year));
  //     setBooks(booksByYear);
  //   };
